                    ...
                    <div class="page_content">
                        ...
                        <div class="leftcol" id="cart_area">
                            ...
                            <div class="checkout_content_box checkout_main">
                                ...
                                <form method="post" accept-charset="utf-8" name="payment_info_form" id="payment_info_form" action="" onsubmit="SubmitPaymentInfoForm();
                                        return false;">
                                                            ...
                                                            <div class="form_row">
                                                                ...
                                                                <div class="dselect_container" id="shipping_state_select_dselect_container" style="display:none">
                                                                    ...
                                                                    <div class="dropcontainer">
                                                                        ...
                                                                        $J('#shipping_state_select_dselect_container').on('keydown', HandleKeyDown);
                                                                    });</script>								</div>
                                                            ...
                                                            <div class="form_row">
                                                                ...
                                                                <div class="dselect_container" id="shipping_country_dselect_container">
                                                                    ...
                                                                    <div class="dropcontainer">
                                                                        ...
                                                                        $J('#shipping_country_dselect_container').on('keydown', HandleKeyDown);
                                                                    });</script>								</div>
                        ...
                        <div id="receipt_area" class="leftcol">
                                ...
                                <div class="checkout_tab checkout_content">
                                    ...
                                    <div class="purchase_summary_area" id="purchase_summary_area">
                                        <p>
                                            <span id="checkout_receipt_description">
                                                An email confirmation has been sent to you.<br /><br/>Any digital items in this order are now registered to your account on Steam.  To access your items, simply visit your <a href="<?php echo base_url('library') ?>">library</a> in Steam whenever you're ready.																		</span>
                                    ...
                                    <div class="receipt_body">
                                        ...
                                        <div class="receipt_confirmation_row">
                                            ...
                                            <div class="receipt_confirmation_data" id="receipt_accountname"><?php echo $order['CustomerUsername']; ?></div>
                                        </div>
                                        <div class="receipt_confirmation_row">
                                            <div class="receipt_confirmation_label">Name</div>
                                            <div class="receipt_confirmation_data" id="receipt_accountname"><?php echo $order['CustomerName']; ?></div>
                                        </div>
                                        <div class="receipt_confirmation_row">
                                            <div class="receipt_confirmation_label">Email</div>
                                            <div class="receipt_confirmation_data" id="receipt_accountname"><?php echo $order['CustomerEmail']; ?></div>
                                        </div>
                                        <div class="receipt_confirmation_row">
                                            <div class="receipt_confirmation_label">Total</div>
                                            <div class="receipt_confirmation_data" id="receipt_total_price">Rp <?php echo number_format( $order['OrderTotal'], 0, ',', ' '); ?></div>
                                        </div>
                                        <div class="receipt_confirmation_row">
                                            <div class="receipt_confirmation_label">Reference ID</div>
                                            <div class="receipt_confirmation_data" id="receipt_confirmation_code"><?php echo $order['OrderID']; ?></div>
                                        </div>
                                                ...
                                                <div class="cart_item">
                                                    <div class="cart_item_price_container">
                                                        <div class="cart_item_price ">
                                                            <div class="price">Rp <?php echo number_format( $item["GamesPrice"], 0, ',', ' ') ; ?></div>
                                                        </div>
                                                    </div>
                                                    <div class="checkout_review_item_img "><a href="<?php echo base_url('Products'); ?>">
                                                            ...
                                                            <img height="45" width="120" src="<?php echo $imageURL; ?>" border="0"></a>
                                                    </div>
                                                    <div class="cart_item_desc">
                                                        <div class="cart_item_platform">
                                                            <span class="platform_img win"></span>									
                                                        </div>
                                                        <a href=""><?php echo $item["GamesName"]; ?></a><br>
                                                    </div>
                                                    <div style="clear: left"></div>
                                                </div>
                                                <?php
                            ...
                            <a href="<?php echo base_url() ?>products" class="btnv6_blue_hoverfade btn_medium" style="float: left; margin-top: 14px;">
