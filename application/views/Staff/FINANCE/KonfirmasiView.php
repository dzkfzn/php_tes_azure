                                        ...
                                        <?php if (empty($qorder)) { ?>
                                            ...
                                            foreach ($qorder as $roworder) {
                                                ...
                                                <tr> 
                                                 ...
                                                 <!--    <td>
                                                        <?php if ($roworder->OrderStatusActive == 0) { ?>
                                                            <a href="<?php echo base_url() ?>KonfirmasiOrder/Approve/<?php echo $roworder->OrderID ?>"> <button class="ds-setting">Not-Confirmed</button></a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url() ?>KonfirmasiOrder/form/Detail/<?php echo $roworder->OrderID ?>" title="Detail" class="pd-setting">Detail</a>
