                                            ...
                                            <div class="review-content-section">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <b><label name="nama" class="login2 pull-left">: <?php echo $name ?></label> </b>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                ...
                                                <div class="form-group-inner">
                                                 ...
                                                 <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <b><label class="login2 pull-left" name="email">: <?php echo $email ?>  </label> </b>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                <button class="btn btn-default" onClick="window.location.href = '<?php echo base_url(); ?>KonfirmasiOrder';return false;">Back to List</button>
                                                <button class="btn btn-success" onClick="window.location.href = '<?php echo base_url(); ?>KonfirmasiOrder/Approve/<?php echo $id ?>';return false;">Confirm Order</button>
                                                <button class="btn btn-primary waves-effect waves-light m-r-10" onClick="window.location.href = '<?php echo base_url(); ?>KonfirmasiOrder/Reject/<?php echo $id ?>';return false;">Reject Order</button>
