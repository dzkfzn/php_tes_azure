                    ...
                    <div class="review-tab-pro-inner">
                        ...
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            <div class="product-tab-list tab-pane fade active in" id="description">
                                <form action="<?php echo base_url() ?>discount/form/aksi_add_regular" method="post">
                                                ...
                                                <div class="form-group-inner" data-custon-pick data-custom-mg" id="data_5">    
                                                     <div class="row">
                                                        ...
                                                        <div class="input-daterange input-group" id="datepicker">
                                                            <input type="text" class="form-control" id="DiscountStartDate" name="DiscountStartDate" value="<?php echo $startDate ?>"/>
                                                            <span class="input-group-addon">to</span>
                                                            <input type="text" class="form-control" id="DiscountEndDate" name="DiscountEndDate" value="<?php echo $endDate ?>" />
                                                        </div>
