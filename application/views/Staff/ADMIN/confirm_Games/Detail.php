                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <div class="sparkline10-list mg-tb-30">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row"> 
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label class="login2 pull-left">Download Games</label>
                                                        </div>
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <b><a href="<?php echo base_url('games/download/' . $GamesPath); ?>" class="login2 pull-left">: Here!  </a> </b>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                ...
                                                <?php if ($GamesStatusVerif != 0) { ?>
                                                    <button class="btn btn-primary waves-effect waves-light m-r-10" onClick="window.location.href = '<?php echo base_url(); ?>confirm_Games';return false;">Back to List</button>

                                                <?php } else { ?> 
                                                    <button class="btn btn-success" onClick="window.location.href = '<?php echo base_url(); ?>confirm_Games/form/accept/<?php echo $GamesID; ?>';return false;">Accept</button>
                                                    <button class="btn btn-warning" onClick="window.location.href = '<?php echo base_url(); ?>confirm_Games/form/reject/<?php echo $GamesID; ?>';return false;">Reject</button>
                                                    <button class="btn btn-primary waves-effect waves-light m-r-10" onClick="window.location.href = '<?php echo base_url(); ?>confirm_Games';return false;">Back to List</button>
