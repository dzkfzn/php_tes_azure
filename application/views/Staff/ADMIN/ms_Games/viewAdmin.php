...
<div class="data-table-area mg-tb-15">
    <div class="container-fluid">
        ...
        <!--                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() ?>games/form/detail_admin/<?php echo $rowgames->GamesID ?>" title="Detail" class="pd-setting-ed"><i class="fa fa-eye" aria-hidden="true"></i></a>

                                                        <a href="<?php echo base_url() ?>games/form/edit/<?php echo $rowgames->GamesID ?>" title="Edit" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
