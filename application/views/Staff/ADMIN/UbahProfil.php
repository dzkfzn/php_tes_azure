                    ...
                    <div class="review-tab-pro-inner">
                        ...
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            <div class="product-tab-list tab-pane fade active in" id="description">
                                <form action="<?php echo base_url() ?>Change_Identity/form/editStaff" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="review-content-section">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" required name="StaffName"  readonly value="<?php echo $name ?>" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" required name="StaffEmail" readonly value="<?php echo $email ?>" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                ...
                                                                <input type="text"  required name="StaffUsername" readonly onkeypress="return RestrictSpace()"  value="<?php echo $username ?>" class="form-control">
                                                                                                                    </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" required name="StaffEmail" readonly value="<?php echo $name_role ?>" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                       ...
                                                       <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" required name="StaffGender" readonly value="<?php echo $StaffGender ?>" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <a  class="thumbnail border">
                                                                <img src="<?php echo base_url('gambar/' . $StaffPicture); ?>" id="img" width="200" height="250" alt="foto">
                                                            </a>
                                               ...
                                               <!--  <div class="form-group-inner">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <div>
                                                                <select id="district" class="chosen-select" name="StaffDistrict" data-placeholder="Select Districts">
                                                                    <option value="0"></option>
                                                                    <?php
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <div>
                                                                <select id="village" class="chosen-select" name="StaffVillage" data-placeholder="Select Village">
                                                                    <option value="0"></option>
                                                                    <?php
