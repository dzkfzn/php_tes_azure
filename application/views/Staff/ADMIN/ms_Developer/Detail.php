...
if ($isLengkap == 1) {
    ...
    if ($qdata) {
        foreach ($qdata as $rowdata) {
            ...
            $phone = $rowdata->DeveloperPhone;
            $wallet= $rowdata->DeveloperWallet;

            if ($rowdata->DeveloperCreatedDate) {
                $createdDate = $rowdata->DeveloperCreatedDate;
            } else {
                $createdDate = "-";
            }

            if ($rowdata->DeveloperModifiedDate) {
                $modifiedDate = $rowdata->DeveloperModifiedDate;
            } else {
                $modifiedDate = "-";
            }
            if ($rowdata->LastAccess) {
                $lastAccess = date_format(date_create($rowdata->DeveloperLastAccess), 'l jS F Y \o\n g:ia');
            } else {
                $lastAccess = "-";
            }
            if ($rowdata->DeveloperImagePath) {
                $lastAccess = date_format(date_create($rowdata->DeveloperImagePath), 'l jS F Y \o\n g:ia');
            } else {
                $lastAccess = "-";
            }
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="review-content-section">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label class="login2 pull-left">Wallet</label>
                                                        </div>
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <b><label class="login2 pull-left">: <?php echo $wallet; ?>  </label> </b>
                                                        </div>
                                                    </div>
                                                </div>
