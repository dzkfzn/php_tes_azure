                                                ...
                                                <!--                                                DEV, SMENTARA DI VIEW DOLO 
                                                                                                <div class="form-group-inner">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                                                            <input type="text"   name="DeveloperID" value="" class="form-control" />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>-->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group data-custon-pick col-lg-9 col-md-9 col-sm-9 col-xs-12" id="data_1">
                                                            <div class="input-group date " >
                                                                ...
                                                                <input type="text" required readonly="readonly" name="GamesReleaseDate" id="GamesReleaseDate" placeholder="Choose Date" class="form-control" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="review-content-section">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text"  name="SyReqOS"  value="<?php echo $SyReqOS ?>" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text"  name="SyReqCPU"  value="<?php echo $SyReqCPU ?>" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text"   name="SyReqRAM"  value="<?php echo $SyReqRAM ?>" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="review-content-section">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text"   name="SyReqVGA"  value="<?php echo $SyReqVGA ?>" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text"  name="SyReqHDD"  value="<?php echo $SyReqHDD ?>" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--DirectX KE 3--> 
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text"  name="SyReqDirectX"  value="<?php echo $SyReqDirectX ?>" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
