        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar" class="">
                <div class="sidebar-header">
                    <a href="<?php echo base_url(); ?>assets/Admin/index.php"><img class="main-logo" src="<?php echo base_url(); ?>assets/Admin/img/logo/game.png" alt="" /></a>
                    <strong><img src="<?php echo base_url(); ?>assets/Admin/img/logo/game.png" alt="" /></strong>
                </div>
                <div class="left-custom-menu-adp-wrap comment-scrollbar">
                    <nav class="sidebar-nav left-sidebar-menu-pro">
                        <ul class="metismenu" id="menu1">
                            <?php $this->load->view('Staff/DEVELOPER/MenuDeveloper'); ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="logo-pro">
                            <a href="<?php echo base_url(); ?>assets/Admin/index.html"><img class="main-logo" src="<?php echo base_url(); ?>assets/Admin/img/logo/game.png" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                            <div class="header-right-info">
                                                <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                    ...
                                                    <li class="nav-item"><a href="<?php echo base_url(); ?>assets/Admin/#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa fa-bell-o" aria-hidden="true"></i><span class="indicator-nt"></span></a>
                                                        <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                            ...
                                                            <div class="notification-view">
                                                                <a href="<?php echo base_url(); ?>assets/Admin/#">View All Notification</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="nav-item">
                                                        ...
                                                        <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                            <li><a href="<?php echo base_url(); ?>assets/Admin/register.html"><span class="fa fa-home author-log-ic"></span>Register</a>
                                                            </li>
                                                            <li><a href="<?php echo base_url(); ?>assets/Admin/#"><span class="fa fa-user author-log-ic"></span>My Profile</a>
                                                            </li>
                                                            <li><a href="<?php echo base_url(); ?>assets/Admin/lock.html"><span class="fa fa-diamond author-log-ic"></span> Lock</a>
                                                            </li>
                                                            <li><a href="<?php echo base_url(); ?>assets/Admin/#"><span class="fa fa-cog author-log-ic"></span>Settings</a>
                                                            </li>
                                                            <li><a href="<?php echo base_url(); ?>assets/Admin/login.html"><span class="fa fa-lock author-log-ic"></span>Log Out</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li class="nav-item nav-setting-open"><a href="<?php echo base_url(); ?>assets/Admin/#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa fa-tasks"></i></a>

                                                        <div role="menu" class="admintab-wrap menu-setting-wrap menu-setting-wrap-bg dropdown-menu animated zoomIn">
                                                            <ul class="nav nav-tabs custon-set-tab">
                                                                <li class="active"><a data-toggle="tab" href="<?php echo base_url(); ?>assets/Admin/#Notes">News</a>
                                                                </li>
                                                                <li><a data-toggle="tab" href="<?php echo base_url(); ?>assets/Admin/#Projects">Activity</a>
                                                                </li>
                                                                <li><a data-toggle="tab" href="<?php echo base_url(); ?>assets/Admin/#Settings">Settings</a>
                                                                </li>
                                                            </ul>
